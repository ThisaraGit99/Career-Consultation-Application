...
<?php
    ...
    if(isset($_POST['Usr-login']))
    {
      ...
      $u_pwd=($_POST['u_pwd']);//
      $stmt=$mysqli->prepare("SELECT u_email, u_pwd, u_id FROM jobs_user WHERE u_email=? and u_pwd=? ");//sql to log in user
      ...
      {//get user logs
        ...
        $log="insert into userLog(u_id, u_email) values('$uid','$uemail')";
        $mysqli->query($log);
        if($log)
        {
...
<head>
  ...
  <title>THE JOBS - Client Login</title>
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="../home.html">Home</a>
        </div>
      </div>
    </div>
  </div>

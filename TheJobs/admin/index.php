...
<?php
    ...
    if(isset($_POST['admin_login']))
    {
      ...
      $a_pwd=($_POST['a_pwd']);//
      $stmt=$mysqli->prepare("SELECT a_email, a_pwd, a_id FROM jobs_admin WHERE a_email=? and a_pwd=? ");//sql to log in user
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <a class="d-block small mt-3" href="../home.html">Home</a>
